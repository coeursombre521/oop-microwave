#ifndef __INTERFACE_MICROWAVE_APPLICATION_H_
#define __INTERFACE_MICROWAVE_APPLICATION_H_

#include <functional>
#include <string>

class IMicrowaveApplication
{
public:
    virtual ~IMicrowaveApplication() = default;
